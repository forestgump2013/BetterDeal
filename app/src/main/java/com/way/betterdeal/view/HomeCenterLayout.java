...
public class HomeCenterLayout extends LinearLayout {
	...
	public  int MENU_border_Width = 50;
	
	public boolean subViewFling;
...
//		this.mScroller = new Scroller(context);
	...
	public void setPage(int whichpg) {
		...
		//	targetX = -(getViewWidthInPix(context)-80);
			mCurState = LEFT;
	...
	/*
	public void setBrotherLayout(View left, LinearLayout right) {
		this.leftLayout = left;
		this.rightLayout = right;
	} */
	...
	public void setSubViewIsFling(boolean flag){
		this.subViewFling=flag;
	}
