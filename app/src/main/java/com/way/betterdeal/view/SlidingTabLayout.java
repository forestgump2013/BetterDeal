...
//import demo.slidingtablayout.R;
...
public class SlidingTabLayout extends LinearLayout {
    ...
    /*当前选中的页面位置*/
    private int mSelectedPosition,currentPosition,lastPosition,scrollLength,paddingValue;
    /*页面的偏移量*/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        /*绘制滑动的页卡*/
        float lift=2 * getResources().getDisplayMetrics().density;
        float yDis=height-lift;
        
        //draw track
    //    canvas.drawRect(0,yDis-mIndicatorHeight,getWidth(),yDis,mBottomPaint);
        
        canvas.drawRect(left+paddingValue/2, yDis-mIndicatorHeight , right-paddingValue/2, yDis, mIndicatorPaint);
    ...
    //	mViewPager.setCurrentItem(position);
    	this.getChildAt(position).performClick();
    }
            ...
            if(positionOffset==0){
            	...
            	if(currentPosition>lastPosition){
            		...
            		if(currentPosition==3 || currentPosition==4  ){
            			horizontalScrollView.smoothScrollBy(scrollLength/3, 0);
