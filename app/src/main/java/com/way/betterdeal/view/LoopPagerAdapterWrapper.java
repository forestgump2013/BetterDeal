...
public class LoopPagerAdapterWrapper extends PagerAdapter {
    ...
    LoopPagerAdapterWrapper(LoopViewPager paramLoopViewPager,PagerAdapter adapter) {
        this.mAdapter = adapter;
        mViewPager=paramLoopViewPager;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        this.mViewPager.setObjectForPosition(object, position);
        return object;
