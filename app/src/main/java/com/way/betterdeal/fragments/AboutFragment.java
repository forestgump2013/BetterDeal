...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        appIcon=(CircleImageView)view.findViewById(R.id.appIcon);
    ...
    private void init(){
        ...
        RelativeLayout.LayoutParams params=(RelativeLayout.LayoutParams)appIcon.getLayoutParams();
        params.width=params.height=StaticValueClass.screenWidth*33/108;
        params.topMargin=StaticValueClass.screenWidth*11/108;
