...
public class TabsPagerAdapter extends PagerAdapter implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	...
	private final TabHorizontalScrollView  aTabHorizontalScrollView;

	public TabsPagerAdapter(FragmentActivity activity, TabHost tabHost,
			ViewPager pager,TabHorizontalScrollView  tabHorizontalScrollView) {
		...
		aTabHorizontalScrollView=tabHorizontalScrollView;
	}
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		Log.d("instantiateItem", "position:"+position+"fragment tag:"+tag);
		return fragment;
	}
	...
	//	throw new AssertionError();
		...
		currentTransaction.remove(fragmentList.get(position));
	...
	public void onPageSelected(int position) {
		...
		aTabHorizontalScrollView.checkScroll(position);
