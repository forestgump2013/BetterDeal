...
public class WheelView extends View {
	...
	/** 车轮的头和尾的渐渐暗色 */
	public static final int[] SHADOWS_COLORS = new int[] { 0x00ffff99,
	...
	/** 默认的车轮中饭的item数目 */
	public static final int DEF_VISIBLE_ITEMS = 1;

	// 车轮当前值
	public int currentItem = 0;
	// 车轮可视的item个数
	public int visibleItems = DEF_VISIBLE_ITEMS;
	// 车轮每个item的高度
    ...
    public boolean isScrollingPerformed,isStoped; 
	...
	// 车轮循环
	public WheelRecycle recycle = new WheelRecycle(this);
	// 车轮监听器（车轮当前值改变的监听器，滚动监听器，点击监听器）
	public List<OnWheelChangedListener> changingListeners = new LinkedList<OnWheelChangedListener>();
	public List<OnWheelScrollListener> scrollingListeners = new LinkedList<OnWheelScrollListener>();
    public List<OnWheelClickedListener> clickingListeners = new LinkedList<OnWheelClickedListener>();
	...
	WheelScroller.ScrollingListener scrollingListener = new WheelScroller.ScrollingListener() {
        ...
        //	Log.d("scrollingListener onStarted", "**");
        ...
        //	Log.d("scrollingListener onScroll", "distance"+distance);
            doScroll(distance);
        ...
        //	Log.d("scrollingListener onFinished", "**");
        ...
        //	Log.d("scrollingListener onJustify", "**");
	 ...
	 */
	public int getDesiredHeight(LinearLayout layout) {
	 ...
	 */
	public int calculateLayoutWidth(int widthSize, int mode) {
   ...
   //     drawShadows(canvas);
	...
	//	Log.d("drawItems", "canvas.translate y:"+(- top + scrollingOffset));
	...
	public void controllStopScroll(){
		isStoped=false;
		while(!isStoped){
			scroller.scroll(200, 20);
		}
		
	}
	
	public void forceStopScroll(){
	//	scroller.setInterpolator(new DecelerateInterpolator(2.0f));
	 ...
	 */
	public boolean addViewItem(int index, boolean first) {
